...
(function (angular) {
    ...
    function vPaneController($scope) {
        ...
        $scope.drawnToScreen = false;

        ctrl.isExpandedOnceOrMore = function isExpandedOnceOrMore() {
            return $scope.drawnToScreen || $scope.isExpanded;
        };
        ...
        ctrl.isVisible = $scope.isExpanded;

        ctrl.toggle = function toggle() {
            $scope.drawnToScreen = true;
        ...
        $scope.internalControl = {
            ...
            isExpandedOnceOrMore: ctrl.isExpandedOnceOrMore
        };
    }
