...
@Component({
    selector: 'app-assets-data-table',
    templateUrl: 'assets-data-table.component.html',
    styleUrls: ['base-data-table.component.css']
})
export class AssetsDataTable extends BaseDataTable<Asset> {
    ...
    setupColumns(): void {
        this.displayColumns.push('name', 'active', 'type', 'category', 'recoveryTime');
